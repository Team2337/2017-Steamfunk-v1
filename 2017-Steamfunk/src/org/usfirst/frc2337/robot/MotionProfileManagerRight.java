...
public class MotionProfileManagerRight {
	 ...
	 */
	public MotionProfileManagerRight(CANTalon talon) {
		_talon = talon;
		/*
	...
	private void startFilling() {
		...
		startFilling(MotionProfilePointsRight.Points, MotionProfilePointsRight.kNumPoints);
	}

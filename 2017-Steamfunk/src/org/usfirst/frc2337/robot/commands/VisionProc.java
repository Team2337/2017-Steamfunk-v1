 ...
 */
public class VisionProc extends Command {
...
//	Constants for known variables
	...
	static VideoCapture vidCap = Robot.videoCapture;
	static GripPipeline tracker = Robot.trackerObj;
	static Mat matOriginal = new Mat();
...
//				opens up the camera stream and tries to load it
				...
				//videoCapture.open("http://10.23.37.20:1181/?action=stream");
				vidCap.open(0);
...
//		only run for the specified time
	...
	public static double distanceFromTarget(){
		...
		distanceFromTarget = DISTANCE_CONSTANT;

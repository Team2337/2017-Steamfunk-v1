 ...
 *
 */
public class Auton_MMTurnBlue extends Command {
    ...
    protected void initialize() {
		...
		*/
    	...
    	rev = Robot.constants.kTargetingCamera_RevDegree * Robot.constants.kAuton_TurnDegreeRed;
    	System.out.println(rev);
    	
    	RobotMap.chassisPID_leftFront.set(rev); 
		RobotMap.chassisPID_rightFront.set(-rev); //BLUE

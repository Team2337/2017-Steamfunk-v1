...
import org.usfirst.frc2337.robot.MotionProfileManagerLeft40ballRed;

import org.usfirst.frc2337.robot.MotionProfileManagerRight40ballRed;
 ...
 *
 */
public class ControlProfile40ballRed extends Command {
	 ...
	 public MotionProfileManagerLeft40ballRed leftTalonManager = RobotMap.leftManager40ballRed;
	 public MotionProfileManagerRight40ballRed rightTalonManager = RobotMap.rightManager40ballRed;
	 double timeout = 2.9; // was 3.5 DATE 3-10-17 KETTERING MATCH 2 was 3 kettering match 6 

    public ControlProfile40ballRed() {

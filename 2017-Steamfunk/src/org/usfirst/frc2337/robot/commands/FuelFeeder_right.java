...
/**
 * Fuel Feeder RIGHT - Move the feeder in the right direction
 */
public class FuelFeeder_right extends Command {
	/**
	...
	protected void execute() {
		...
		augerLeft.set(-feederSpeedLeft);//speed

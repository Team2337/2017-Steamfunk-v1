...
public class MotionProfileManagerLeft40ballRed {
	 ...
	 */
	public MotionProfileManagerLeft40ballRed(CANTalon talon) {
		_talon = talon;
		/*
	...
	public void control() {
		...
		MotionProfileInstrumentation.process(_status);
	}

	/** Start filling the MPs to all of the involved Talons. */
	private void startFilling() {
		/* since this example only has one talon, just update that one */
		startFilling(MotionProfilePointsLeft40ballAcc288.Points, MotionProfilePointsLeft40ballAcc288.kNumPoints); // was Ac10Red change after match 39
	}

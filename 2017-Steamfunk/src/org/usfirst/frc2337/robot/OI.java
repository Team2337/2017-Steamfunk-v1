...
public class OI {
	...
	public OI() {
		...
		driver_BumperLeft		.whenPressed(new FuelIntakeArm_extend());
		driver_BumperRight		.whenPressed(new FuelIntake_start());
		...
		driver_TriggerLeft		.whileHeld(new FuelIntakeArm_retract());
		driver_TriggerRight		.whileHeld(new FuelIntake_stop());

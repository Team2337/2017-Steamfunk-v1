...
public class Robot extends IterativeRobot {
	...
	RobotMap.init();
		...
		autonChooser.addDefault("Do Nothing",			new _DoNothing());
		autonChooser.addObject("Cross Line",			new _DoNothing());
		autonChooser.addObject("Score 40: Red",			new _DoNothing());
		autonChooser.addObject("Score 40: Blue",		new _DoNothing());
		autonChooser.addObject("Score Gear: Left",		new _DoNothing());
		autonChooser.addObject("Score Gear: Middle",	new _DoNothing());
		autonChooser.addObject("Score Gear: Right",		new _DoNothing());

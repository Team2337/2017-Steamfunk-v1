...
public class RobotMap {
    ...
    public static void init() {
        ...
        fuelShooter_motorRight.setInverted(false);
        ...
        fuelShooter_motorRight.changeControlMode(TalonControlMode.Voltage);
        fuelShooter_motorRight.setVoltageCompensationRampRate(24.0);
        
        fuelShooter_motorLeft = new CANTalon(12);
        LiveWindow.addActuator("FuelShooter", "fuelShooterLeft", fuelShooter_motorLeft);
        fuelShooter_motorLeft.changeControlMode(TalonControlMode.Follower);
        fuelShooter_motorLeft.set(13);
        // FUEL SHOOTER

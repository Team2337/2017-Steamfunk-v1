...
public class RobotMap {
    ...
    public static DigitalInput limitSwitchEndRight;
    public static DigitalInput limitSwitchMiddleRight;
    public static DigitalInput limitSwitchFrontRight;
    //Left side auger limit switches
    public static DigitalInput limitSwitchEndLeft;
    public static DigitalInput limitSwitchMiddleLeft;
    public static DigitalInput limitSwitchFrontLeft;
    ...
    public static void init() {
        ...
        LiveWindow.addActuator("FuelAgitator", "auger", auger);
        limitSwitchEndRight = new DigitalInput(0);
        limitSwitchMiddleRight = new DigitalInput(1);
        limitSwitchFrontRight = new DigitalInput(2);
        limitSwitchEndLeft = new DigitalInput(3);
        limitSwitchMiddleLeft = new DigitalInput(4);
        limitSwitchFrontLeft = new DigitalInput(5);

...
public class FuelShooter extends Subsystem {
    ...
    private final CANTalon fuelShooterLeft = RobotMap.fuelShooterfuelShooterLeft;
    private final CANTalon fuelShooterRight = RobotMap.fuelShooterfuelShooterRight;
